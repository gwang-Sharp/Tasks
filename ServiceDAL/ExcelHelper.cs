...
namespace ServiceDAL
{
    public class ExcelHelper
    {
        ...
        #region 右击文件 属性信息
        private static void SetDocumentSummaryInformation(HSSFWorkbook workbook, string Company, string Author, string ApplicationName, string LastAuthor, string Comments, string Title, string Subject, DateTime CreateDateTime)
        {
